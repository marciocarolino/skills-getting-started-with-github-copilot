...
activities = {
    ...
    "Swimming Club": {
        ...
        "max_participants": 18,
        "participants": ["sarah@mergington.edu", "nick@mergington.edu"]
    },
    "Art Studio": {
        "description": "Explore drawing, painting, and mixed media art projects",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["maya@mergington.edu", "ella@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Science Research Group": {
        "description": "Work on scientific investigations and present research findings",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
